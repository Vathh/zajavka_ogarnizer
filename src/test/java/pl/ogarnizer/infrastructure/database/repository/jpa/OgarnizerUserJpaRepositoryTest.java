...
public class OgarnizerUserJpaRepositoryTest {
    ...
    void thatUserCanBeSavedCorrectly(){
        //given
        List<UserEntity> userEntities = List.of(EntityFixtures.someUserEntity1(),
                EntityFixtures.someUserEntity2(), EntityFixtures.someUserEntity3());
        userJpaRepository.saveAllAndFlush(userEntities);
